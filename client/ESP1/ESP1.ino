...
const char* ssid = "wifi quan chung";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "wifidanghong";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "192.168.1.108";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
